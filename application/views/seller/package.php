                    ...
                    <div class="row bg-gray">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <p><strong>Package Designed for</strong>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <p><strong>Select Theme</strong>
                                    <select name="theme" class="form-control" data-toggle="tooltip" data-placement="top" title="Select a theme for this item. Themed items will show top in the search results when filtered by the said theme. Contact us, for if your theme is not listed here">

                                        <option value="N/A">Non-Themed Package</option>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <p><strong>Private/Public</strong>
                                    <select name="private_public" class="form-control">
                                        <option value=""></option>
                                        <option value="Private">Private</option>
                                        <option value="Public">Public</option>

                                    </select><span class="val_private_public"></span>
                                </p>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <p><strong>Minimum</strong>
                                                <input type="text" name="children_min" list="party_hours" placeholder="" class="form-control">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <p><strong>Maximum</strong>
                                                <input type="text" name="children_max" list="party_minutes" placeholder="" class="form-control">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <p><strong>Minimum</strong>
                                                <input type="text" name="adult_min" list="party_hours" placeholder="" class="form-control">
                                                <datalist id="party_hours">
                                                    <option>N/A</option>
                                                </datalist>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <p><strong>Maximum</strong>
                                                <input type="text" name="adult_max" list="party_minutes" placeholder="" class="form-control" >
                                                <datalist id="party_minutes">
                                                    <option>N/A</option>
                                                </datalist>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <p><strong>Minimum</strong>
                                                <input type="text" name="child_age_min" list="party_hours" placeholder="" class="form-control" >
                                                <datalist id="party_hours">
                                                    <option>N/A</option>
                                                </datalist>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <p><strong>Maximum</strong>
                                                <input type="text" name="child_age_max" list="party_minutes" placeholder="" class="form-control">
                                                <datalist id="party_minutes">
                                                    <option>N/A</option>
                                                </datalist>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    <p><strong>Children Per Head Charge</strong>
                                        ...
                                        <input type="text" name="childern_per_head" list="childern_per_head" placeholder="" class="form-control" >
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    <p><strong>Adults Per Head Charge </strong>
                                        ...
                                        <input type="text" name="adult_per_head" list="adult_per_head" placeholder="" class="form-control">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <p><strong>Package Price </strong>
                                        ...
                                        <input type="text" name="package_price" list="package_price" placeholder="" class="form-control">
                        ...
                        <div class="row bg-middle">
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <p><strong>Type of Food Package</strong>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <p><strong>No. Persons Served</strong>


                                        <input type="text" name="no_persons_served" list="no_persons_served" placeholder="" class="form-control">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <p><strong>Per Head Charge (If applicable)</strong>
                                        ...
                                        <input type="text" name="food_per_head_charge" list="food_per_head_charge" placeholder="" class="form-control">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <p><strong>Package Price (If applicable)</strong>
                                        ...
                                        <input type="text" name="food_package_price" list="food_package_price" placeholder="" class="form-control">
                            ...
                            <p class="text-center" style="color:#7DBE48;"><strong>Tableware</strong></p>
                    ...
                    <div class="row bg-gray">
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <p><strong>Select District</strong>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="form-group">
                                <p><strong>Service Charge</strong>
                                    <input type="text" name="service_charge" list="service_charge" placeholder="" class="form-control">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="form-group">
                                <p><strong>Other Charges</strong>
                                    <input type="text" name="other_charges" list="other_charges" placeholder="" class="form-control">
...
<script>
    ...
    function validateForm() {
        ...
        var private_public = document.forms["myform"]["private_public"].value;
        ...
        if (private_public == null || private_public == "") {

            $("span.val_private_public").html("This field is required.").addClass('validate');
            validation_holder = 1;
        } else {

            $("span.val_private_public").html("");
        }
...
<script>
    ...
    $("#province").change(function() {
        $('#city').empty();
        var province_id = {"province_id": $('#province').val()};
        //console.log(province_id);

        $.ajax({
            type: "POST",
            data: {province_id, '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'},
