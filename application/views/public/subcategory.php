<div class="container">
    ...
    <div class="row">
        <div class="margin-top-10 no-bottom-margin">
            <div class="col-md-12">
                ...
                <img class="img-responsive" src="<?php echo base_url(); ?>asset/images/sub-category-header.jpg" />
    ...
    <div class="margin-top-10 float">
        ...
        if ($maincat == 16 || $maincat == 17 || $maincat == 18 || $maincat == 19 || $maincat == 20 || $maincat == 24 || $maincat == 25) {
            $collection = "Party Items";
            $link = "party-items";
        } elseif ($maincat == 26 || $maincat == 27 || $maincat == 28) {
            $collection = "Foods";
            $link = "foods";
        } elseif ($maincat == 29 || $maincat == 30 || $maincat == 31) {
            $collection = "Games Activites & Services";
            $link = "games-activities-services";
        }
        ?>
        <div class="row sub-cat">
            <div class="col-xs-12 col-sm-4 col-md-5">
                ...
                <div id="bc1" class="btn-group btn-breadcrumb">
                    ...
                    <a href="#" class="btn btn-default"><div><?php echo $subCatName; ?></div></a>
                </div>
            </div>
...
<?php $repurl = str_replace("-", "_", $this->uri->segment(2)); ?>
                    $("#<?php echo $repurl; ?>").css("color", "#FCB040");
                    $("#badge<?php echo $repurl; ?>").css("color", "#FCB040");
                });
            </script>
            <?php
            foreach ($allcats as $cats) {
                if ($cats->slug == $maincatslug) {
                    ?>
        ...
        <?php
        foreach ($subcatslug as $slug) {

            $repslug = str_replace("-", "_", $slug->slug);
            $repurl = str_replace("-", "_", $this->uri->segment(2));
            ...
            if ($repurl == $repslug) {
                ?>
                                        ...
                                        $("#btn<?php echo $slug->slug; ?>").removeClass('collapsed');
                                        $("#<?php echo $maincatslug; ?>").addClass('collapse in');
                <?php
            }
        }
        ?>
                            ...
                            foreach ($allscats as $scats) {
                                ...
                                if ($cats->mcatid == $scats->parentcat) {
                                    ...
                                    echo '<a href="' . site_url() . 'subcategory/' . $scats->slug . '"><li id="' . str_replace("-", "_", $scats->slug) . '" class="list-group-item"><span id="badge' . str_replace("-", "_", $scats->slug) . '" class="badge">' . $count . '</span>' . $scats->name . '</li></a>';
                                }
                                ?>
        ...
        <div class="col-xs-12 col-sm-9 col-md-9">
            ...
            <?php
            if (!empty($allsubcatitems)) {
                foreach ($allsubcatitems as $item) {
                    ?>
