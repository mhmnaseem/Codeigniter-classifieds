        ...
        <div class="row">
            <div class="margin-top-10 no-bottom-margin">
                <div class="col-md-12">
                    ...
                    <img class="img-responsive" src="<?php echo base_url(); ?>asset/images/food_package.jpg" />
        ...
        <div class="row">
            <div class="margin-top-10 float">
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div id="bc1" class="btn-group btn-breadcrumb">
                        <a href="<?php echo base_url(); ?>" class="btn btn-default"><i class="fa fa-home"></i></a>
                        <a href="#" class="btn btn-default"><div>Food Packages</div></a>
                    </div>
                </div>
...
//                                }
                                ...
                                itemsf.push($('<div class="col-xs-12 col-sm-12 col-md-4"><table class = "table table-striped"><tbody><tr><td><img src="<?php echo base_url('files/thumb/') ?>' + val.pack_image + '" class="img-responsive"></td></tr><tr><td>' + val.pack_title + '</td></tr><tr><td>Theme: ' + val.theme + '</td></tr><tr><td> Type of Food Package: ' + val.type_food_package + '</td></tr><tr><td> No. Persons Served:' + val.no_persons_served + '</td></tr><tr><td> Waiters Provided: ' + val.waiters_provided + '</td></tr><tr><td>Per Head Charge: ' + val.food_per_head_charge + '</td></tr><tr><td> Package Price: ' + val.food_package_price + ' </td></tr><tr><td> Plates: ' + val.food_plates + ' </td></tr><tr><td> Cups: ' + val.food_cups + ' </td></tr><tr><td> Straws: ' + val.food_straws + ' </td></tr><tr><td> Cutlery: ' + val.food_cutlery + ' </td></tr><tr><td> Napkins: ' + val.food_napkins + ' </td></tr><tr><td> Chafing Dishes: ' + val.food_chafing_dishes + ' </td></tr><tr><td> Delivery/Transport Cost: ' + val.delivery_cost + ' </td></tr><tr><td> Service Charge: ' + val.service_charge + ' </td></tr><tr><td> Other Charges: ' + val.other_charges + ' </td></tr></tbody></table></div>'));
