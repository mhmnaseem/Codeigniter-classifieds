...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Edit Themes</h1>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <form enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/editthemes" method="post" onsubmit="return validateForm()" name="myform" id="register_form input">
