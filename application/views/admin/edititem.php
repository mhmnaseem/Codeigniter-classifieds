        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <?php foreach ($selecteditem as $item) { ?>
                    ...
                    <form  method="post" action="<?php echo base_url() . 'admin/edititem/' . $id ?>" id="form" onsubmit="return validateForm()" name="myform">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a class="btn btn-lg btn-ml-cancel btn-block" href="<?php echo base_url('admin') ?>">Cancel</a>
                            </div>
                        </div>
                        <br>
                        <br>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h4>Add New Image </h4>
                <form id="myAwesomeDropzone" action="<?php echo base_url() . 'admin/EdititemimageUpload/' . $id ?>" method="post" enctype="multipart/form-data" class="dropzone">
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    <div class="fallback">
...
<script>
    function deletegallimg(id) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/deleteimagegallery'); ?>",
